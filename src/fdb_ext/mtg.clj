...
;; - scryfall has api for their card data
;;   - card objects https://scryfall.com/docs/api/bulk-data
;;   - then use fields for card images https://scryfall.com/docs/api/images
